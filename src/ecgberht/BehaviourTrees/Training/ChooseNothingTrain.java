...
public class ChooseNothingTrain extends Action {
    ...
    public State execute() {
        try {
            ...
            boolean stim = gameState.strat.techToResearch.contains(TechType.Stim_Packs);
            ...
            boolean siege = gameState.strat.techToResearch.contains(TechType.Tank_Siege_Mode);
